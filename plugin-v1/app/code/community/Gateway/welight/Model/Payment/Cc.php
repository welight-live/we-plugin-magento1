 ...
 */
class Welight_Gateway_Model_Payment_Cc extends Welight_Gateway_Model_Abstract
{
    protected $_code = 'rm_welight_cc';
    protected $_formBlockType = 'Welight_Gateway/form_cc';
    protected $_infoBlockType = 'Welight_Gateway/form_info_cc';
     ...
     * @param float $amount
     *
     * @return Welight_Gateway_Model_Payment_Cc
     */
