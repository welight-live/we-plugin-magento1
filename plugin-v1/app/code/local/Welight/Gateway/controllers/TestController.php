...
class Welight_Gateway_TestController extends Mage_Core_Controller_Front_Action
{
    ...
    public function getConfigAction()
    {
        ...
        $info['Welight_Gateway']['debug'] = Mage::getStoreConfigFlag('payment/rm_welight/debug');
        $info['Welight_Gateway']['sandbox'] = Mage::getStoreConfigFlag('payment/rm_welight/sandbox');
