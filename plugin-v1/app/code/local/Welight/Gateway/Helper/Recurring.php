<?php
class Welight_Gateway_Helper_Recurring extends Mage_Core_Helper_Abstract
{

    /**
     * Create a product name to be used and displayed in welight dashboard
     *
    ...
    /**
     * Convert Magento's Recurring Profile Period Unit and frequency to welight's supported standard.
     ...
     * @return bool|string
     */
    public function getwelightPeriod($profile)
    {
        if (is_array($profile)) {
        ...
        switch ($unit) {
            case \Mage_Payment_Model_Recurring_Profile::PERIOD_UNIT_DAY:
                if ($period % 7 == 0) {
                    return \Welight_Gateway_Model_Recurring::PREAPPROVAL_PERIOD_WEEKLY;
                }
                break;
            ...
            case Mage_Payment_Model_Recurring_Profile::PERIOD_UNIT_MONTH:
                switch ($period) {
                    case 1:
                        return \Welight_Gateway_Model_Recurring::PREAPPROVAL_PERIOD_MONTHLY;
                    case 2:
                        return \Welight_Gateway_Model_Recurring::PREAPPROVAL_PERIOD_BIMONTHLY;
                    case 3:
                        return \Welight_Gateway_Model_Recurring::PREAPPROVAL_PERIOD_TRIMONTHLY;
                    case 6:
                        return \Welight_Gateway_Model_Recurring::PREAPPROVAL_PERIOD_SEMIANNUALLY;
                    case 12:
                        return \Welight_Gateway_Model_Recurring::PREAPPROVAL_PERIOD_YEARLY;
                }
                break;
    ...
    public function getCreatePlanParams($profile)
    {
        ...
        $params['preApprovalPeriod'] = $this->getwelightPeriod($profile);
    ...
    {
        if (is_string($obj)) {
            Mage::log($obj, Zend_Log::DEBUG, 'welight_recurring.log', true);
        } else {
            Mage::log(var_export($obj, true), Zend_Log::DEBUG, 'welight_recurring.log', true);
        }
    }
}