<?php
class gatewaywelight_Helper_Recurring extends Mage_Core_Helper_Abstract
{
    ...
    public function getwelightPeriod($profile)
    {
        ...
        switch ($unit) {
            case \Mage_Payment_Model_Recurring_Profile::PERIOD_UNIT_DAY:
                if ($period % 7 == 0) {
                    return \gatewaywelight_Model_Recurring::PREAPPROVAL_PERIOD_WEEKLY;
                }
                break;
            ...
            case Mage_Payment_Model_Recurring_Profile::PERIOD_UNIT_MONTH:
                switch ($period) {
                    case 1:
                        return \gatewaywelight_Model_Recurring::PREAPPROVAL_PERIOD_MONTHLY;
                    case 2:
                        return \gatewaywelight_Model_Recurring::PREAPPROVAL_PERIOD_BIMONTHLY;
                    case 3:
                        return \gatewaywelight_Model_Recurring::PREAPPROVAL_PERIOD_TRIMONTHLY;
                    case 6:
                        return \gatewaywelight_Model_Recurring::PREAPPROVAL_PERIOD_SEMIANNUALLY;
                    case 12:
                        return \gatewaywelight_Model_Recurring::PREAPPROVAL_PERIOD_YEARLY;
                }
                break;
