<?php
/**
 * Class gatewaywelight_Helper_Kiosk
 *
 * @author    Ricardo Martins
 */
class gatewaywelight_Helper_Kiosk extends Mage_Core_Helper_Abstract
{
    ...
    {
        return Mage::getModel('gatewaywelight/kiosk')->loadByOrderId($order_id);
    }

    /**
     * Returns a search for reference on welight
     * @param gatewaywelight_Model_Kiosk $kiosk
     */
