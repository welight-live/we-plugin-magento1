 ...
 */
class gatewaywelight_Helper_Internal extends Mage_Core_Helper_Abstract
{
    /**
    ...
    public function getCreditCardApiCallParams(Mage_Sales_Model_Order $order, $payment)
    {
        ...
        $pHelper = Mage::helper('gatewaywelight/params'); //params helper - helper auxiliar de parametrização
