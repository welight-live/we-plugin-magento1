 ...
 */
class gatewaywelight_Model_Payment_Kiosk extends Mage_Payment_Model_Method_Abstract
{
    protected $_code = 'rm_welight_kiosk';
    protected $_formBlockType = 'gatewaywelight/form_kiosk';
    protected $_infoBlockType = 'gatewaywelight/form_info_kiosk';
