<?php
class gatewaywelight_Model_Healthcheck extends Mage_Core_Model_Abstract
{
    ...
    {
        $mainModuleVersion = (string)Mage::getConfig()->getModuleConfig('gatewaywelight')->version;

        if (Mage::getConfig()->getModuleConfig('gatewaywelightPro')) {
            $proVersion = (string)Mage::getConfig()->getModuleConfig('gatewaywelightPro')->version;
        }
