 ...
 */
class gatewaywelight_Model_Abstract extends Mage_Payment_Model_Method_Abstract
{
    ...
    public function proccessNotificatonResult(SimpleXMLElement $resultXML)
    {
        ...
        if (isset($resultXML->reference)) {
            ...
            if (strstr($orderNo, 'kiosk_') !== false) {
                ...
                Mage::dispatchEvent(
                    'gatewaywelight_kioskorder_notification_received',
            ...
            if ((int)$resultXML->status == 7 && isset($resultXML->cancellationSource)) {
                ...
                Mage::dispatchEvent('gatewaywelight_before_cancel_order', array(
    ...
    public function processStatus($statusCode)
    {
        ...
        switch($statusCode)
        {
            ...
            case '7':
                ...
                if ($this->_order && Mage::helper('gatewaywelight')->canRetryOrder($this->_order)) {
    ...
    public function callApi($params, $payment, $type='transactions')
    {
        ...
        Mage::dispatchEvent(
            'gatewaywelight_params_callapi_before_send',
            array(
                'params' => $params,
                'payment' => $payment,
                'type' => $type
    ...
    public function callJsonApi($body, $headers, $type='pre-approvals', $noV2=false) //phpcs:ignore
    {
        ...
        //you can create a module to modify some parameter using the following observer
        Mage::dispatchEvent(
            'gatewaywelight_params_calljsonapi_before_send',
            array(
                'body' => $body,
                'type' => $type
            )
     ...
     * @param float $amount
     *
     * @return gatewaywelight_Model_Payment_Abstract
     */
     ...
     *
     * @return gatewaywelight_Helper_Data
     */
    protected function _getHelper()
    {
        return Mage::helper('gatewaywelight');
    }
