...
class gatewaywelight_Block_Form_Info_Recurring extends Mage_Payment_Block_Info
{
    /**
     * Set block template
     */
    ...
    {
        parent::_construct();
        $this->setTemplate('gatewaywelight/form/info/recurring.phtml');
    }
    ...
    public function getRecurringProfileId()
    {
        ...
        return Mage::getModel('gatewaywelight/recurring')->getRecurringProfileIdFromOrder($order);
    }
    ...
    {
        return Mage::getModel('gatewaywelight/recurring')
