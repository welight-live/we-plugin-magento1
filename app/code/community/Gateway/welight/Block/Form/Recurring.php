 ...
 */
class gatewaywelight_Block_Form_Recurring extends Mage_Payment_Block_Form_Cc
{
    /**
     * Set block template
     */
    ...
    {
        parent::_construct();
        $this->setTemplate('gatewaywelight/form/recurring.phtml');
    }
    ...
    protected function _prepareLayout()
    {
        ...
        if ($head && false == $head->getChild('js_welight')) {
            $scriptBlock = Mage::helper('gatewaywelight')->getwelightScriptBlock();
    ...
    public function getCcYears()
    {
        ...
        if (null === $years) {
            $years = Mage::helper('gatewaywelight/params')->getYears();
