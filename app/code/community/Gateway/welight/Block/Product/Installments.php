...
class gatewaywelight_Block_Product_Installments extends Mage_Core_Block_Template
{
    ...
    {
        parent::_construct();
        $this->setTemplate('gatewaywelight/product/installments.phtml');
    }
    ...
    public function isEnabled()
    {
        ...
        $maxInstallments = (int)Mage::getStoreConfig(
            gatewaywelight_Helper_Data::XML_PATH_PAYMENT_welight_CC_INSTALLMENT_LIMIT
        );
    ...
    protected function _prepareLayout()
    {
        ...
        if ($head && false == $head->getChild('welight_direct')) {
            $scriptBlock = Mage::helper('gatewaywelight')->getExternalwelightScriptBlock();
