...
$tableName = $installer->getTable('gatewaywelight/kiosk');
...
$kioskTable = $installer->getConnection()->newTable($tableName)
    ...
    ->addColumn('welight_email', Varien_Db_Ddl_Table::TYPE_VARCHAR, 120, array())
...
//criará a tabela gatewaywelight_kiosk // create table gatewaywelight_kiosk
