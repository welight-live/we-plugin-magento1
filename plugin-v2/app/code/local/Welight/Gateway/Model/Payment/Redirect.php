 ...
 */
class Welight_Gateway_Model_Payment_Redirect extends Welight_Gateway_Model_Abstract
{
    const XML_PATH_REDIRECTURL = 'payment/wegateway_redirect/redirectURL';

    protected $_code = 'wegateway_redirect';
    protected $_formBlockType = 'welight_gateway/form_redirect';
    protected $_infoBlockType = 'welight_gateway/form_info_redirect';
    ...
    {
        return Mage::getStoreConfig("payment/wegateway_redirect/{$field}");
    }


    public function order(Varien_Object $payment, $amount)
    {
        /** @var Welight_Gateway_Helper_Internal $pHelper */
        $helper = Mage::helper('welight_gateway/internal');

        /** @var Welight_Gateway_Helper_Data $rmHelper */
